...
public static final int DATABASE_VIRSION = 9;

// XML based interview basic info like schedleId or beneficiaryName.
...
public static final String INTERVIEW_INFO = "interviewInfo";
...
private Context context; 
	...
	public void onCreate(SQLiteDatabase db) {
		String interviewTable = "CREATE TABLE IF NOT EXISTS " + INTERVIEW_TABLE_NAME + " (" + INTERVIEW_TABLE_ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT,  " + INTERVIEW_SCHEDULE_ID + "  TEXT," + INTERVIEW_INFO + "  TEXT" + " );";
	...
	public void insertScheduleInfo(ContentValues value){
		ContentValues cv = value;		
		this.insertInterviewBasicInfo(cv);
	}
	...
	public HashMap<String, String> getInterviewBasicInfo(){
		...
		if(cur != null){
			if(cur.moveToFirst()){
				...
				map.put(INTERVIEW_INFO, cur.getString(cur.getColumnIndex(INTERVIEW_INFO)));
			}			
		}
		cur.close();
		db.close();	
	...
	public HashMap<String, String> getInterviewScheduleId(){
		HashMap<String, String> map = new HashMap<String, String>();
