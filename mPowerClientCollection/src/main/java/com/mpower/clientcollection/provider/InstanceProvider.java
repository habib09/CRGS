...
public class InstanceProvider extends ContentProvider {
    ...
    private static final int INSTANCE_ID = 3;
    ...
    private static class DatabaseHelper extends ClientCollectionSQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
           db.execSQL("CREATE TABLE " + INSTANCES_TABLE_NAME + " ("
               ...
               + InstanceColumns.USER_ID + " text not null, "
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        	...
        	if ( oldVersion == 3 ) {
        		LogUtils.warningLog(this, "Upgrading database ");
        		db.execSQL("ALTER TABLE " + INSTANCES_TABLE_NAME + " ADD COLUMN " +
    					InstanceColumns.USER_ID + " text;");
        	}
    ...
    static {
        ...
        sInstancesProjectionMap.put(InstanceColumns.USER_ID, InstanceColumns.USER_ID);
