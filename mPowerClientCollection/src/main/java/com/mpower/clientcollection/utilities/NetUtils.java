...
public class NetUtils {
	...
	public static final String URL_PART_FEEDBACK = "/usermodule/mFeedback/";
	public static final String URL_PART_AREA = "/usermodule/mAddressAndSpeciality";
	public static final String URL_PART_LAWYER_INFO = "/usermodule/mFilterData";
	public static final String URL_PART_REFERRAL_VIEW = "/usermodule/mReferralView";
	public static final String URL_PART_ASSIGN = "/usermodule/mAssign/";

	public static final String URL_PART_REFERRAL_FILTER_ = "/usermodule/mReferralFilter";
