...
public class DownloadFormListTask extends AsyncTask<Void, String, HashMap<String, FormDetails>> {
    ...
    protected HashMap<String, FormDetails> doInBackground(Void... values) {
        ...
        LogUtils.informationLog(this, "***download url = " + downloadListUrl);
        ...
        Log.i("DownloadFormTask", "***adding username = " + UserCollection.getInstance().getUserData().getUsername() + "  Password = " + UserCollection.getInstance().getUserData().getPassword());
        WebUtils.addCredentials(UserCollection.getInstance().getUserData().getUsername(), NetUtils.getSHA512(UserCollection.getInstance().getUserData().getPassword()));
        ...
        LogUtils.informationLog(this, "*****response code = " + result.responseCode);
