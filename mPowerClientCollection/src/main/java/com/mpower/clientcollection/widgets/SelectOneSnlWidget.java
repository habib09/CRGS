...
public class SelectOneSnlWidget extends QuestionWidget implements
        CompoundButton.OnCheckedChangeListener {

        Vector<SelectChoice> mItems; // may take a while to compute
        ArrayList<RadioButton> buttons;
private static final String TAG = SelectOneSnlWidget.class.getSimpleName();

public SelectOneSnlWidget(Context context, FormEntryPrompt prompt) {
