        ...
        switch (fep.getControlType()) {
            case Constants.CONTROL_INPUT:
                switch (fep.getDataType()) {                 
                    ...
                    case Constants.DATATYPE_TEXT:
                    	...
                    	Log.d("WidgetFactory", "DATATYPE_TEXT and appearance = " + appearance);
                        if (query != null) {
                        ...
                        }else if(appearance.equals("db")){
                        	LogUtils.informationLog(new WidgetFactory(), " Found DatabaseWidget");
                        	questionWidget = new DatabaseWidget(context, fep);
                        }else if(appearance.equals("line_draw")){
                            LogUtils.informationLog(new WidgetFactory(), " Found LineDrawWidget");
                            questionWidget = new LineDrawWidget(context, fep);
                        }else if(appearance.equals("html")){
                            questionWidget = new HtmlWidget(context, fep);
                        }else {
            ...
            case Constants.CONTROL_SELECT_MULTI:
                if (appearance.contains("compact")) {
                    ...
                    questionWidget = new DragDropWidget(context, fep);
                } else {
