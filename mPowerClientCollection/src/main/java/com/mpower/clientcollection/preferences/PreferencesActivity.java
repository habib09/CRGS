...
public class PreferencesActivity extends PreferenceActivity implements
	...
	public static final String KEY_MQTT_SERVER_PORT = "mqtt_port";
	public static final String KEY_MQTT_SERVER_PORT_SETTING = "mqtt_port_setting";
	...
	public static final String KEY_COMPLETED_SETUP = "setup_completed";
	public static final String KEY_BRANCH_NAME = "branch_name";
	public static final String KEY_ALREADY_LOGGED_IN = "already_logged_in";
	...
	private EditTextPreference mMqttPortPreference;
...
*/
	...
	private void updateMqttPortSetting(){
		PreferenceCategory serverCategory = (PreferenceCategory) findPreference(KEY_MQTT_SERVER_PORT_SETTING);		
		if(!ClientCollection.getInstance().getIsUsePushNotification())
			serverCategory.setEnabled(false);
		
		mMqttPortPreference = (EditTextPreference) findPreference(KEY_MQTT_SERVER_PORT);
		mMqttPortPreference
				.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
						...
						if (port.length() == 4) {
							...
							Log.d(PreferencesActivity.class.getSimpleName(), "port = " + port);
							return true;
						} else {
							Toast.makeText(getApplicationContext(),
									R.string.port_error, Toast.LENGTH_SHORT)
									.show();
							return false;
						}
					}
				});
		mMqttPortPreference.setSummary(mMqttPortPreference.getText());
