...
public abstract class ClientCollection extends Application {
	    ...
	    private static boolean userLibraryNotificaton = true;
	    private static boolean userPushNotificaton = false;
	    public static String DYN_FOLDER_INTRNT_FILTER = "android.intent.action.ODK.Table";
	    public static String DYN_MAIN_INTRNT_FILTER = "android.intent.action.mpower.csa.main_view";
		public static String DYN_SIGN_UP_INTRNT_FILTER = "android.intent.action.mpower.csa.reg_view";
		public static String DYN_FORGET_INTRNT_FILTER = "android.intent.action.mpower.csa.forget";
	    ...
	    public static void isUseLibraryNotification(boolean userLibraryNotificaton){
	    	ClientCollection.userLibraryNotificaton = userLibraryNotificaton;
	    }
	    
	    public boolean getIsUseLibraryNotification(){
	    	return ClientCollection.userLibraryNotificaton;
	    }
	    
	    public static void isUsePushNotification(boolean userPushNotificaton){
	    	ClientCollection.userPushNotificaton = userPushNotificaton;
	    }
	    
	    public boolean getIsUsePushNotification(){
	    	return ClientCollection.userPushNotificaton;
	    }
	    
	    public void syncTargetApplicationNotificationData(String message) {
			notificationArrived(message);
		}
	     ...
	     */
	    public static void setDynActivityIntentFilter(String intentFilterTable, String folderName, String intentFilterMain){
	    	ClientCollection.DYN_FOLDER_INTRNT_FILTER = intentFilterTable;
	    	ClientCollection.DYN_FOLDER_NAME = folderName;
	    	ClientCollection.DYN_MAIN_INTRNT_FILTER = intentFilterMain;
	    }
	   ...
	   /**
	    ...
	    private BroadcastReceiver authenticationDoneReceiver = new BroadcastReceiver() {
			...
			//	PushService.actionStart(getApplicationContext());
				Log.i("ClientCollection", "Authentication done");
				if(getIsUsePushNotification())
	    ...
	    private class CallListener{
	    	CallListener(){
	    		...
	    		isUseLibraryNotification();
	    		isUsePushNotification();
	    	}
	    }
	 ...
	 // MPOWER: Encrypt and decrypt a file.
	    ...
	    public static void decodeFile(byte[] bytesOfFile) throws Exception{
	    	...
	    	decodeFile(yourKey, bytesOfFile);
	    }
	    ...
	    /**
	     * Target application can use own messaging module by setting userLibraryNotification false
	     * 
	     * @return void
	     * @param userLibraryNotificaton - should be like: ClientCollection.userLibraryNotificaton = false or true depending
	     * on target application purpose.
	     */
	    protected abstract void isUseLibraryNotification();
	    
	    protected abstract void isUsePushNotification();
	    
	    protected abstract void notificationArrived(String mssage);
